...
var FacebookFeed = function () {
    ...
    function fetchFacebookFeed() {
        return __awaiter(this, void 0, void 0, function () {
            var res, fetchedFeed, renderedFeed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("https://graph.facebook.com/998665673528998/feed?limit=21&fields=id,likes,reactions,comments,shares,attachments,full_picture,message,from,permalink_url&access_token=" + token)];
                    case 1:
                        res = _a.sent();

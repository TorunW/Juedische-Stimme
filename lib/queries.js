/* GALLERIES */
    ...
    export function inserGalleryImage(body){
        const {image_src, image_title, image_description, image_gallery, image_order} = body
    ...
    export function updateGalleryImage(body){
        const {image_src, image_title, image_description, image_gallery, image_order, galleryImageId} = body
